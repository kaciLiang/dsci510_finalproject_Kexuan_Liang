...
|---|------|------|--------|------|-----------|
| 1 | Instagram Engagement Analytics | File (Kaggle, Google Drive) | CSV | [Download](https://drive.google.com/uc?export=download&id=1kFbRKn3x2SVt6eo6XElhePFKiKBMDKbw) | ~20,000 posts |
| 2 | Viral Social Media Trends | File (Kaggle, Google Drive) | CSV | [Download](https://drive.google.com/uc?export=download&id=16Jq-lwlSK43wWLmo5iSvfqjju7yZHVHd) | ~5,000 rows |
| 3 | YouTube Data API v3 | API | JSON | [Docs](https://developers.google.com/youtube/v3) | ~400 videos |
